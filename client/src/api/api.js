...
export const searchUserAPI = (username) => {
  return axios.get(searchUserRoute, { params: { username } }).then((res) => res)
}
...
export const deleteGroupAPI = (chatId) => {
  return axios.delete(deleteGroupRoute, { data: { chatId } }).then((res) => res)
}
...
export const searchGroupChatsAPI = (keyword) => {
  return axios.get(searchGroupRoute, { params: { keyword } }).then((res) => res)
}
